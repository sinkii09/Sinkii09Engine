...
namespace Sinkii09.Engine.Services
{
    ...
    [Obsolete("Use EngineServiceAttribute with OptionalServices property instead. This attribute will be removed in a future version.")]
    public class OptionalServiceAttribute : Attribute
    {
        public readonly Type[] ServiceTypes;

        public OptionalServiceAttribute(params Type[] serviceTypes)
        {
